		 ...
		 */
		 ...
		 function add_popup_box(){
			 ...
			 var pop_up = $('<div class="paulund_modal_box"><a class="paulund_modal_close"></a><div class="paulund_inner_modal_box"><h2>' + options.title + '</h2>'
                                ...
                                +'<input id = "" name = "type" class = "element radio" type = "radio" value = "1" checked> <label class = "choice" for = "element_4_1"> Неизвестно </label><br>'
                                +'<input id = "" name = "type" class = "element radio" type = "radio" value = "2"> <label class = "choice" for = "element_4_2"> Мечеть </label><br>'
                                +'<input id = "" name = "type" class = "element radio" type = "radio" value = "3"> <label class = "choice" for = "element_4_3"> Намазкана </label><br><br> ' 
                                + '<label class = "description" for = "element_4"> Гендер: </label><br>'
                                + '<input id = "" name = "gender" class = "element radio" type = "radio" value = "1" checked> <label class = "choice" for = "element_4_1"> Неизвестно </label><br>'
                                + '<input id = "" name = "gender" class = "element radio" type = "radio" value = "2"> <label class = "choice" for = "element_4_2"> Мужской </label><br>'
                                + '<input id = "" name = "gender" class = "element radio" type = "radio" value = "3"> <label class = "choice" for = "element_4_3"> Женский </label><br>' 
                                + '<input id = "" name = "gender" class = "element radio" type = "radio" value = "4"> <label class = "choice" for = "element_4_3"> Мужской/Женский </label><br><br>' 
